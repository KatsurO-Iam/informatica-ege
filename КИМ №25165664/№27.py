...
arifA_X = (centrsA[0][0] + centrsA[-1][0]) / 2
arifA_Y = (centrsA[0][1] + centrsA[-1][1]) / 2
#-------------------------------------------------------------------#
...
#-------------------------------------------------------------------#
#-------------------------------------------------------------------#
print(abs(int(arifA_X * 100_000)), abs(int(arifA_Y * 100_000)))
print(abs(int(arifB_X * 100_000)), abs(int(arifB_Y * 100_000)))
#-------------------------------------------------------------------#
# 23684 65128
# 72353 130974
